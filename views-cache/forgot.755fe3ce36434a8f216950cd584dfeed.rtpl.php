...
<body background="#ffffff">
  ...
  <div align="center">
    <table class="head-wrap w320 full-width-gmail-android" background="#f9f8f8" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td background="https://www.filepicker.io/api/file/UOesoVZTFObSHCgUDygC" background="#ffffff" width="100%" height="8" valign="top">
          <!--[if gte mso 9]>
